...
# If you haven't checked out my Breakout sixth sense basic version then I would encourage you to check that first from https://github.com/Pranshu1902/Breakout-Sixth-sense-version
...
img = pygame.image.load('Rules(3).png')
